...
async fn test_full_system_integration() {
    ...
    // Test 2: Mining manager initialization
    let mining_manager = Arc::new(
        MiningManager::new(config.clone())
            .await
...
fn create_integration_test_config() -> Config {
    Config {
        mining: cgminer_rs::config::MiningConfig {
            ...
            work_restart_timeout: Duration::from_secs(10),
            enable_auto_tuning: false, // Disable for predictable testing
        },

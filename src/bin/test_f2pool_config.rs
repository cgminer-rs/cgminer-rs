...
fn main() {
    ...
    // 显示配置信息
    let pools = vec![
        ("主矿池", "stratum+tcp://btc.f2pool.com:1314", "kayuii.bbt", "21235365876986800"),
        ("亚洲矿池", "stratum+tcp://btc-asia.f2pool.com:1314", "kayuii.bbt", "21235365876986800"),
        ("欧洲矿池", "stratum+tcp://btc-euro.f2pool.com:1314", "kayuii.bbt", "21235365876986800"),
    ];
